                            ...
                            <div class="col-lg-12">
                                <div class="au-card chart-percent-card">
                                    <div class="au-card-inner">
                                        <h3 class="title-2 tm-b-5">Cuestionarios - Sistema Nervioso</h3>
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-xl-6">
                                                <div class="chart-note-wrap">
                                                    <?php 
                                                        $consulta = mysqli_query($q_sec,"SELECT * FROM cuestionarios WHERE id_modulo='1' order by id_cuestionario asc");
                                                        $control_color = 0;
